To fix rate edits do the following:

- If you have never run osu!trainer before, run osu!trainer
- Find the modified_mp3_list inside your osu songs folder
- Run the exe
- Press 1 to enter the pass
...
- if you have a 1.1x do a 1.11x or something like that 
